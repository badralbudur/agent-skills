...
**First**, ensure your own user's side is set up. They need a Fulcra account (use the `fulcra-connect` skill if needed) so you have their Fulcra User ID ready to share.
